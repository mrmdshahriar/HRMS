    ...
    public class EmployeeProfileController : Controller
    {
        ...
        public ActionResult GetAllEmployees()
        {
           ...
           //var items = _hrms.HrmEmployees.Where(x => x.FirstName != null).ToList();
            ...
            foreach (var item in items)
            {
                ...
                {
                    data = item,
                    JoiningDate = item.JoiningDate?.ToString("dd/MM/yyyy")
                };
                data.Add(obj);
        ...
        public ActionResult GetEmployeeById(int id)
        {
            try
            {
                ...
                {
                    data,
                    JoiningDate = data.JoiningDate?.ToString("yyyy-MM-dd"),
        ...
        [HttpPost]
        public ActionResult InsertUpdateEmployee(HrmEmployee employee)
        {
            string message = "";
            if (employee.Id > 0)
            {
        ...
        [HttpPost]
        public JsonResult UploadExcel(HrmEmployee employee, HttpPostedFileBase FileUpload)
        {
                ...
                if (FileUpload.ContentType == "application/vnd.ms-excel" || FileUpload.ContentType == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
                {
                    ...
                    foreach (var a in artistAlbums)
                    {
                        try
                        {
                            ...
                            TU.JoiningDate = Convert.ToDateTime(a.JoiningDate);
